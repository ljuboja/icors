    ...
    <div class="comments">
        ...
        <?php if ( have_comments() ) : ?>
            <?php if ( function_exists( 'unspoken_commentCount' ) && unspoken_commentCount( 'comments' ) != 0 ) : ?>
                ...
                printf( _n( '1 komentar', '%1$s komentara', unspoken_commentCount('comments'), 'unspoken' ),
                number_format_i18n( unspoken_commentCount('comments') ) );
                ?><a href="#respond"><?php _e( 'Pošalji tvoj komentar','unspoken' ); ?></a></div>
                ...
                <?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
                    <div class="navigation clear">
                        <div class="nav-previous"><?php previous_comments_link( __( '<span class="meta-nav">&larr;</span> Stariji komentar', 'unspoken' ) ); ?></div>
                        <div class="nav-next"><?php next_comments_link( __( 'Noviji komentari<span class="meta-nav">&rarr;</span>', 'unspoken' ) ); ?></div>
                    </div><!-- .navigation -->

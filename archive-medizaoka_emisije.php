...
<?php if ( is_post_type_archive( 'medizaoka_emisije' ) ) { ?>
<p id="breadcrumbs">Vi ste ovde: <a href="http://www.ico.rs">Home</a> > <a href="http://www.ico.rs/medizaoka_emisije/">Med i zaoka</a> > </p>
<?php } else { ?>

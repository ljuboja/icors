...
class wpshower_homepage_block extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        ?>
            ...
            <div class="latest clear">
                ...
                <div class="latest-news">
                    <div class="block-title"><?php _e('Poslednje Vesti', 'unspoken'); ?></div>
                    <ul>
                    <?php
                        $args = array(
        ...
        ?>
            ...
            <div class="choice">
                <div class="block-title2"><?php echo $choice_title; ?><a href="javascript:void(0);" class="prev"></a><a href="javascript:void(0);" class="next"></a></div>
        ...
        ?>
            ...
            <div class="video clear">
                <div class="block-title"><?php echo $video_title; ?></div>

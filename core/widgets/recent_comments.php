        ...
        ?>
            ...
            <li class="hentry-thumb hentry-thumb-comment clear">
                ...
                <span class="hentry-thumb-title <?php echo $offset; ?>"><?php echo $comment->comment_author; ?>
                    <span>&mdash;</span> <a href="<?php echo get_permalink($comment->comment_post_ID); ?>#comment-<?php echo $comment->comment_ID; ?>" title="<?php printf( 'Komentar na  &quot;%1$s&quot;', get_the_title($comment->comment_post_ID) ); ?>"><?php unspoken_excerpt($comment->comment_content, 20); ?></a></span>
             </li>

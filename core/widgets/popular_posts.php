...
class wpshower_popular_posts extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $posts = $wpdb->get_results("SELECT * FROM $wpdb->posts WHERE post_type = 'post' AND post_status = 'publish' AND post_date > '$interval' ORDER BY comment_count DESC LIMIT 0 , $number");
        echo '<ul>';

...
<?php if ( is_singular( 'hronike' ) ) { ?>
<p id="breadcrumbs">Vi ste ovde: <a href="http://www.ico.rs">Home</a> > <a href="http://www.ico.rs/hronike">Nedeljne hronike</a> > <strong><?php the_title(); ?></strong></p>
<?php } else { ?>
    ...
    <div class="hentry-container clear">
        ...
        <div class="hentry-sidebar">
            ...
            <div class="hentry-widget hentry-share">
                <h6><?php _e( 'Podeli ovaj članak', 'unspoken' ); ?></h6>
                <ul>
